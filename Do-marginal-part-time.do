...
use "/Users/agnesmolnar/Documents/UPF/Master Thesis/New Order/marginal-part-time.dta", clear

*generate origin state (PT) Two-States
   gen org = 0
   gen des = 1 if pgemplst[_n+1]==5
   gen tf = fin - start 
 ...
 *Kaplan Meyer
 ...
 sts graph, by(training) ci title("") 
...
recode workint (0=1) (0.1/max=0)	


 gen nomism= mismatch==1
 
 gen fulltimeexp0 = pgexpft
 recode fulltimeexp0 (0/4.9=0) (5/9.9=1) (10/14.9=2) (15/max=3)
 replace fulltimeexp0= . if fulltimeexp0==-1
 ...
 * percentage change in the rate, changes its value*/
 ...
 streg d11101 region i.firmsize d11107 ib2.sector i.childhh training, dist(e) nohr 	/**fit parametric survival model*/
 streg d11101 region i.firmsize  d11107 ib2.sector i.childhh nomism, dist(e) nohr
 streg d11101 regio i.firmsize d11107 ib2.sector i.childhh i.fulltimeexp0, dist(e) nohr
